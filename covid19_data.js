...
let covid19Data = [
    ...
    },
    {
        ...
        info: [
            {
                title: "зарегистрировано 36 случаев коронавируса",
                description:
                    `COVID-19 диагностирован у пяти студентов БГУ. Предварительный тест дал положительный результат.
                    За выходные также зарегистрированы положительные тесты у еще четырех граждан Беларуси.
                    Они прибыли из Мюнхена, Амстердама и Москвы.`,
                datetime: "2020-03-16"
            },
            {
...
{id: 'SA', name: 'Саудовская Аравия', fill:  COLOR_GRAY, info: []},
...
{id: 'SG', name: 'Сингапур', fill:  COLOR_GRAY, info: []},
...
{id: 'TH', name: 'Таиланд', fill:  COLOR_GRAY, info: []},
